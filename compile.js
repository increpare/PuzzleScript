...
npm i web-resource-inliner ncp rimraf compress-images gifsicle glob concat ycssmin terser html-minifier-terser gzipper
*/
    ...
    glob("./bin/Documentation/images/*.gif", {}, async function (er, files) {
        ...
        function(err,inlined){
            if(err) {
                ...
                fs.writeFileSync("./bin/standalone_inlined.txt",inlined);
            }
        });
